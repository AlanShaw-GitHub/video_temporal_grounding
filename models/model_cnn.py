...
class Model(object):
    ...
    def build_model(self):
        ...
        with tf.variable_scope("Frame_Embedding_Encoder_Layer"):
            ...
            frame_next_layer = conv_utils.conv_encoder_stack(frame_next_layer, [256,256,256], [3,3,3],
                                                  {'src': self.dropout,
        ...
        with tf.variable_scope("Ques_Embedding_Encoder_Layer"):
            ...
            ques_next_layer = conv_utils.conv_encoder_stack(ques_next_layer, [256,256], [3,3],
                                                      {'src': self.dropout,
                                                       'hid': self.dropout}, mode=self.is_training)
        ...
        with tf.variable_scope("Model_Encoder_Layer"):
            ...
            model_outputs = conv_utils.conv_encoder_stack(model_next_layer, [256,256], [3,3],
                                                      {'src': self.dropout,
                                                       'hid': self.dropout}, mode=self.is_training)
